    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="bg-white p-6 shadow-md rounded-lg mb-8">
                <h1 className="text-center mb-4 text-2xl font-bold tracking-tight text-gray-900">
                    Bienvenido a la Cigarreria Colonial, {userName}
                </h1>
                <p className="text-center mb-4 text-xl font-bold tracking-tight text-gray-900">
